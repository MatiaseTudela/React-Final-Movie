    ...
    return(
        <div className="row" id="movieDetail">
			...
			<div className="col-12 col-md-8" id="movieInfo">
				...
				<h5>Reseña: </h5>
				<p>{movie.overview || 'No se encontro reseña de la pelicula.'}</p>
				<h4 className="card-title one-line-title" >Popularidad: {movie.vote_average}</h4>
